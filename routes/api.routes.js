...
router.get(
  "/dashboard",
  authorize("admin"),
  adminController.getDashboardController
);

router.get(
  "/pendingTransactions",
  authorize("admin"),
  adminController.getPendingTransactionsController
);

router.get(
  "/completedTranscations",
  authorize("admin"),
  adminController.getCompletedTranscationsController
);
...
router.get(
  "/edit_user/:id",
  authorize("admin"),
  adminController.postEditUserController
);

router.post(
  "/update_user",
  authorize("admin"),
  adminController.postUpdateUserController
);

router.get(
  "/view_transactions/:id",
  authorize("admin"),
  adminController.getUserTransactionsController
);

router.get(
  "/view_pending_transactions/:id",
  authorize("admin"),
  adminController.getUserPendingTransactionsController
);

router.post(
  "/verify_transaction",
  // authorize("admin"),
  adminController.postVerifyUserTransaction
);

router.get(
  "/complaints",
  authorize("admin"),
  adminController.getComplaintsController
);

router.get(
  "/out_of_stock",
  authorize("admin"),
  adminController.getDisabledProductsController
);

// UTILITY APIs
router.get("/details", utilityController.getDetailsController);

router.post("/buy", verifyToken, utilityController.postBuyController);
...
router.get(
  ...
  isAuthenticated,
  authorize("user"),
  userController.getContactUsController
);
...
router.get("/profile", verifyToken, userController.getProfileController);

router.post("/deleteaccount", userController.postDeleteAccountController);
